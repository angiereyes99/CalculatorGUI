...
9. To run unit tests you can simply select any of the files in test/java. Also you may right-click on the java folder inside test and select run all tests to run all given unit tests.
